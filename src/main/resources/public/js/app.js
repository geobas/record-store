(function() {
	...
	app.config(function($stateProvider, $urlRouterProvider, $controllerProvider){
		...
		$stateProvider
			...
			.state('records',{
	        url:'/records',
	        templateUrl: viewsPrefix + 'records.html',
	        controller:'RecordsListController'
	    }).state('viewRecord',{
	       url:'/records/:id/view',
	       templateUrl: viewsPrefix + 'record-view.html',
	       controller:'RecordViewController'
	    }).state('newRecord',{
	        url:'/records/new',
	        templateUrl: viewsPrefix + 'record-add.html',
	        controller:'RecordCreateController'
	    }).state('editRecord',{
	        url:'/records/:id/edit',
	        templateUrl: viewsPrefix + 'record-edit.html',
